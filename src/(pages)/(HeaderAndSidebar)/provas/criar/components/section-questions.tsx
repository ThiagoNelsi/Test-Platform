...
import QuestionRenderer from "@/src/components/question-renderer";
...
export default function SectionQuestions({
  ...
  const handleSetRandomQuestionCount = (
    e: React.ChangeEvent<HTMLInputElement>,
  ) => {
    if (
      Number(e.target.value) > section.questions.length ||
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Adicione todas as questões desta seção na prova dos alunos.
            </p>
            {section.selectionMode === "all" && (
              <div className="text-sm flex items-center gap-2 mt-2">
                ...
                <label className="cursor-pointer" htmlFor="shuffle">
                  Embaralhar questões para cada aluno
                </label>
              </div>
            )}
          </Card>
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Escolha quantas questões desta seção serão sorteadas para cada
              aluno.
            </p>
            ...
            <div className="flex gap-2">
              ...
              <div className="flex flex-col gap-10">
                <Button
                  ...
                  className="self-start w-5 h-4 mt-1 cursor-pointer text-xs rounded-full border-neutral-500 bg-neutral-500 text-white"
                >
                  <IoClose />
                </Button>
                <div className="ml-2">
