                ...
                {filteredQuestions.map((question) => {
                    ...
                    return (
                        <ScrollArea
                            ...
                            className={"group relative h-[400px] bg-white border-2 px-4 py-2 rounded-lg cursor-pointer" + (selected.some(q => q.id === question.id) ? " border-green-500" : " border-gray-300")}
                        >
