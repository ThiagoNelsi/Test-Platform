      ...
      <div ref={formRef}>
        <div className={cn('space-y-4', className)}>
          <div className="space-y-1">
            <Label>URL</Label>
            <Input type="url" required placeholder="Digite a URL" value={url} onChange={e => setUrl(e.target.value)} />
          </div>

          <div className="space-y-1">
            <Label>Texto de exibição (optional)</Label>
            <Input type="text" placeholder="Digite o texto de exibição" value={text} onChange={e => setText(e.target.value)} />
          </div>

          <div className="flex justify-end space-x-2">
            <Button className='bg-verdigris hover:bg-verdigris-400' type="button" onClick={handleSave}>
              Salvar
            </Button>
          </div>
        </div>
