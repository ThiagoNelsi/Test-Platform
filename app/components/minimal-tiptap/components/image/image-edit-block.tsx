    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-1">
        ...
        <div className="flex">
          ...
          />
          <Button type="submit" className="ml-2 bg-verdigris-500 hover:bg-verdigris-400">
            Enviar
          </Button>
        </div>
      </div>
      <p className='text-sm'>Ou faça upload de uma imagem de seu computador</p>
      <Button type="button" className="w-full bg-verdigris-500 hover:bg-verdigris-400" onClick={handleClick}>
