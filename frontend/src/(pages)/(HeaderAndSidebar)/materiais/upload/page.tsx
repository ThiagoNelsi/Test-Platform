            ...
            <div className="space-y-6">
              ...
              {uploadComplete && (
                <Alert className="mb-4 bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
                  ...
                  <AlertDescription>
                    Todos os {files.length} arquivos foram enviados e serão processados antes de ficarem disponíveis para geração de questões.
                  </AlertDescription>
                  <Button
                    variant="outline"
                    size="sm"
                      ...
                      <div className="flex items-start gap-3">
                        <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center">
                          {fileData.previewUrl ? (
                            ...
                            <FileIconComponent fileType={fileData.file.type} />
                          )}
                        </div>
            ...
            <div className="space-y-4 py-4">
              <div className="flex items-center gap-3 mb-4">
                {editingFile.previewUrl ? (
                  ...
                  <FileIconComponent fileType={editingFile.file.type} />
                )}
                <div>
